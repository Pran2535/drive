...
// hum jwt ke madad se ek token generate karte hai and then
// cookie parser ki help se hum use store karvate hai
...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      res.cookie("token", token); // hamne cookie ko setup kar liya ab hum cookie ko token diye hai
      res.send("Logged in successfully"); // or response me hamne ise logged in successfully ka message print kar diya hai
    } catch (error) {
